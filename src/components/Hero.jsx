export default function Hero() {
  return (
    <section className="relative overflow-hidden border-b border-white/5">
      ...
      <div className="pointer-events-none absolute -top-32 left-1/2 h-72 w-[60rem] -translate-x-1/2 rounded-full bg-neon-cyan/10 blur-3xl" />
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center px-6 pb-20 pt-28 text-center md:pb-28 md:pt-36">
        ...
        <h1
          className="hero-tagline hero-glitch crt-flicker neon-text-soft mt-6 font-arcade text-2xl leading-snug sm:text-3xl md:text-5xl"
          style={{ color: 'var(--neon-cyan-soft)' }}
        >
          INSERT COIN TO PLAY
          <span
            className="ml-2 inline-block w-3 -translate-y-1 animate-blink align-middle md:w-4"
