  ...
  return (
    <section className="relative overflow-hidden border-b border-white/5">
      ...
      <div className="relative mx-auto flex max-w-5xl flex-col items-center px-6 py-20 text-center md:py-28">
        <p className="font-arcade text-[10px] text-neon-cyan/80 md:text-xs">
          ★ WELCOME TO ARCADIA ★
        </p>
        <h1 className="mt-6 font-arcade text-2xl leading-snug text-neon-green drop-shadow-[0_0_14px_rgba(0,255,136,0.55)] sm:text-3xl md:text-5xl">
          INSERT COIN TO PLAY
